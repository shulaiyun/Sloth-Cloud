...
const flags: Record<string, string> = {
  ...
  'ko-KR': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 48"><rect width="64" height="48" rx="8" fill="#fff"/><path d="M24 24a8 8 0 1 1 16 0 8 8 0 0 0-16 0z" fill="#CD2E3A"/><path d="M40 24a8 8 0 1 1-16 0 8 8 0 0 0 16 0z" fill="#0047A0"/></svg>`,
};
