...
use App\Console\Commands\ProvisioningRun;
...
Schedule::command(ProvisioningRun::class, ['--limit' => 25])->description('Processes queued service provisioning jobs')->everyMinute()->withoutOverlapping()->onOneServer();
